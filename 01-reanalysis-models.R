...
# Seibold et al presented the results using the grassland and arable land cover metrics
# at the 1000 m scale

forest$year2 <- scale(forest$CollectionYear)
forest$landuse_intensity2 <- scale(forest$landuse_intensity)
forest$mean_winter_temperature2 <- scale(forest$mean_winter_temperature)
forest$precipitation_sum_growing_preriod2 <- scale(forest$precipitation_sum_growing_preriod)
forest$grassland_cover_10002 <- scale(forest$grassland_cover_1000)
forest$arable_cover_10002 <- scale(forest$arable_cover_1000)

biomass_forest2_env_noyear <- lmer(log_biomass ~ year2  + landuse_intensity2 + mean_winter_temperature2 +
                              precipitation_sum_growing_preriod2 + 
                              grassland_cover_10002 + arable_cover_10002 +
                              mean_winter_temperature2*precipitation_sum_growing_preriod2 +
                              year2:landuse_intensity2 + year2:grassland_cover_10002 +
                              year2:arable_cover_10002 +
                              (1|region/PlotID), data = forest)

summary(biomass_forest2_env_noyear)

biomass_forest2_env <- lmer(log_biomass ~ year2  + landuse_intensity2 + mean_winter_temperature2 +
                              precipitation_sum_growing_preriod2 + 
                              grassland_cover_10002 + arable_cover_10002 +
                              mean_winter_temperature2*precipitation_sum_growing_preriod2 +
                              year2:landuse_intensity2 + year2:grassland_cover_10002 +
                              year2:arable_cover_10002 + (1|yearfactor) +
                              (1|region/PlotID), data = forest)
summary(biomass_forest2_env)


forest_all$year2 <- scale(forest_all$CollectionYear)
forest_all$landuse_intensity2 <- scale(forest_all$landuse_intensity)
forest_all$mean_winter_temperature2 <- scale(forest_all$mean_winter_temperature)
forest_all$precipitation_sum_growing_preriod2 <- scale(forest_all$precipitation_sum_growing_preriod)
forest_all$grassland_cover_10002 <- scale(forest_all$grassland_cover_1000)
forest_all$arable_cover_10002 <- scale(forest_all$arable_cover_1000)

biomass_forest_all2_env_noyear <- lmer(log_biomass ~ year2  + landuse_intensity2 + mean_winter_temperature2 +
                                  precipitation_sum_growing_preriod2 + 
                                  grassland_cover_10002 + arable_cover_10002 +
                                  mean_winter_temperature2*precipitation_sum_growing_preriod2 +
                                  year2:landuse_intensity2 + year2:grassland_cover_10002 +
                                  year2:arable_cover_10002 + (1|region/PlotID), data = forest_all)

summary(biomass_forest_all2_env_noyear)

biomass_forest_all2_env <- lmer(log_biomass ~ year2  + landuse_intensity2 + mean_winter_temperature2 +
                                  precipitation_sum_growing_preriod2 + 
                                  grassland_cover_10002 + arable_cover_10002 +
                                  mean_winter_temperature2*precipitation_sum_growing_preriod2 +
                                  year2:landuse_intensity2 + year2:grassland_cover_10002 +
                                  year2:arable_cover_10002 + (1|yearfactor) + (1|region/PlotID), data = forest_all)


summary(biomass_forest_all2_env)
...
# With environmental variables
grass$year2 <- scale(grass$CollectionYear)
grass$landuse_intensity2 <- scale(grass$landuse_intensity)
grass$mean_winter_temperature2 <- scale(grass$mean_winter_temperature)
grass$precipitation_sum_growing_preriod2 <- scale(grass$precipitation_sum_growing_preriod)
grass$grassland_cover_10002 <- scale(grass$grassland_cover_1000)
grass$arable_cover_10002 <- scale(grass$arable_cover_1000)

biomass_grass2_env_noyear <- lmer(log_biomass ~ year2  + landuse_intensity2 + mean_winter_temperature2 +
                             precipitation_sum_growing_preriod2 + 
                             grassland_cover_10002 + arable_cover_10002 +
                             mean_winter_temperature2:precipitation_sum_growing_preriod2 +
                             year2:landuse_intensity2 + year2:grassland_cover_10002 +
                             year2:arable_cover_10002  + (1|region/PlotID), data = grass)
summary(biomass_grass2_env_noyear)

biomass_grass2_env <- lmer(log_biomass ~ year2  + landuse_intensity2 + mean_winter_temperature2 +
                             precipitation_sum_growing_preriod2 + 
                             grassland_cover_10002 + arable_cover_10002 +
                             mean_winter_temperature2:precipitation_sum_growing_preriod2 +
                             year2:landuse_intensity2 + year2:grassland_cover_10002 +
                             year2:arable_cover_10002 + (1|yearfactor) + (1|region/PlotID), data = grass)
summary(biomass_grass2_env)
...
# With environmental variables
abundance_forest2_env_noyear <- glmer(abundance_identified ~ year2  + landuse_intensity2 + mean_winter_temperature2 +
                                 precipitation_sum_growing_preriod2 + 
                                 grassland_cover_10002 + arable_cover_10002 +
                                 mean_winter_temperature2:precipitation_sum_growing_preriod2 +
                                 year2:landuse_intensity2 + year2:grassland_cover_10002 +
                                 year2:arable_cover_10002 +
                                (1|region/PlotID), family = "poisson", data = forest)
summary(abundance_forest2_env_noyear)

abundance_forest2_env <- glmer(abundance_identified ~ year2  + landuse_intensity2 + mean_winter_temperature2 +
                                 precipitation_sum_growing_preriod2 + 
                                 grassland_cover_10002 + arable_cover_10002 +
                                 mean_winter_temperature2:precipitation_sum_growing_preriod2 +
                                 year2:landuse_intensity2 + year2:grassland_cover_10002 +
                                 year2:arable_cover_10002 +
                                 (1|yearfactor) + (1|region/PlotID), family = "poisson", data = forest)
summary(abundance_forest2_env)

abundance_forest_all2_env_noyear <- glmer(abundance_identified ~ year2  + landuse_intensity2 + mean_winter_temperature2 +
                                     precipitation_sum_growing_preriod2 + 
                                     grassland_cover_10002 + arable_cover_10002 +
                                     mean_winter_temperature:precipitation_sum_growing_preriod2 +
                                     year2:landuse_intensity2 + year2:grassland_cover_10002 +
                                     year2:arable_cover_10002 +
                                      (1|region/PlotID), family = "poisson", data = forest_all)
summary(abundance_forest_all2_env_noyear)

abundance_forest_all2_env <- glmer(abundance_identified ~ year2  + landuse_intensity2 + mean_winter_temperature2 +
                                     precipitation_sum_growing_preriod2 + 
                                     grassland_cover_10002 + arable_cover_10002 +
                                     mean_winter_temperature:precipitation_sum_growing_preriod2 +
                                     year2:landuse_intensity2 + year2:grassland_cover_10002 +
                                     year2:arable_cover_10002 +
                                     (1|yearfactor) + (1|region/PlotID), family = "poisson", data = forest_all)
summary(abundance_forest_all2_env)
...
# With environmental variables
abundance_grass2_env_noyear <- glmer(abundance_identified ~ year2 + landuse_intensity2 + mean_winter_temperature2 +
                                precipitation_sum_growing_preriod2 + 
                                grassland_cover_10002 + arable_cover_10002 +
                                mean_winter_temperature2:precipitation_sum_growing_preriod2 +
                                year2:landuse_intensity2 + year2*grassland_cover_10002 +
                                year2:arable_cover_10002 +
                                 (1|region/PlotID), family = "poisson", data = grass)
summary(abundance_grass2_env_noyear)

abundance_grass2_env <- glmer(abundance_identified ~ year2 + landuse_intensity2 + mean_winter_temperature2 +
                                 precipitation_sum_growing_preriod2 + 
                                 grassland_cover_10002 + arable_cover_10002 +
                                 mean_winter_temperature2:precipitation_sum_growing_preriod2 +
                                 year2:landuse_intensity2 + year2*grassland_cover_10002 +
                                 year2:arable_cover_10002 +
                                 (1|yearfactor) + (1|region/PlotID), family = "poisson", data = grass)
summary(abundance_grass2_env)
...
# With environmental variables
species_forest2_env_noyear <- glmer(species ~ year2  + landuse_intensity2 + mean_winter_temperature2 +
                               precipitation_sum_growing_preriod2 + 
                               grassland_cover_10002 + arable_cover_10002 +
                               mean_winter_temperature2:precipitation_sum_growing_preriod2 +
                               year2:landuse_intensity2 + year2:grassland_cover_10002 +
                               year2:arable_cover_10002 +
                               (1|yearfactor) + (1|region/PlotID), family = "poisson", data = forest)
summary(species_forest2_env_noyear)

species_forest2_env <- glmer(species ~ year2  + landuse_intensity2 + mean_winter_temperature2 +
                                 precipitation_sum_growing_preriod2 + 
                                 grassland_cover_10002 + arable_cover_10002 +
                                 mean_winter_temperature2:precipitation_sum_growing_preriod2 +
                                 year2:landuse_intensity2 + year2:grassland_cover_10002 +
                                 year2:arable_cover_10002 +
                                 (1|yearfactor) + (1|region/PlotID), family = "poisson", data = forest)
summary(species_forest2_env)

species_forest_all2_env_noyear <- glmer(species ~ year2  + landuse_intensity2 + mean_winter_temperature2 +
                                   precipitation_sum_growing_preriod2 + 
                                   grassland_cover_10002 + arable_cover_10002 +
                                   mean_winter_temperature:precipitation_sum_growing_preriod2 +
                                   year2:landuse_intensity2 + year2:grassland_cover_10002 +
                                   year2:arable_cover_10002 +
                                    (1|region/PlotID), family = "poisson", data = forest_all)
summary(species_forest_all2_env_noyear)

species_forest_all2_env <- glmer(species ~ year2  + landuse_intensity2 + mean_winter_temperature2 +
                                     precipitation_sum_growing_preriod2 + 
                                     grassland_cover_10002 + arable_cover_10002 +
                                     mean_winter_temperature:precipitation_sum_growing_preriod2 +
                                     year2:landuse_intensity2 + year2:grassland_cover_10002 +
                                     year2:arable_cover_10002 +
                                     (1|yearfactor) + (1|region/PlotID), family = "poisson", data = forest_all)
summary(species_forest_all2_env)
...
# With environmental variables
species_grass2_env_noyear <- glmer(species ~ year2  + landuse_intensity2 + mean_winter_temperature2 +
                              precipitation_sum_growing_preriod2 + 
                              grassland_cover_10002 + arable_cover_10002 +
                              mean_winter_temperature2:precipitation_sum_growing_preriod2 +
                              year2:landuse_intensity2 + year2:grassland_cover_10002 +
                              year2:arable_cover_10002 +
                                (1|region/PlotID), family = "poisson", data = grass)
summary(species_grass2_env_noyear)
species_grass2_env <- glmer(species ~ year2  + landuse_intensity2 + mean_winter_temperature2 +
                               precipitation_sum_growing_preriod2 + 
                               grassland_cover_10002 + arable_cover_10002 +
                               mean_winter_temperature2:precipitation_sum_growing_preriod2 +
                              year2:landuse_intensity2 + year2:grassland_cover_10002 +
