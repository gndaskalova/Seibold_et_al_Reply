...
# Model summary table ----
#Run models and produce output table.
...
year_slope_variance[3]<-round(bfv3[which(bfv3$var1=="yearcenter"),"vcov"],3)
...
year_slope_variance[6]<-round(bfv3all[which(bfv3all$var1=="yearcenter"),"vcov"],3)
...
year_variance[9]<-round(bgv3[which(bgv3$grp=="yearfactor"),"vcov"],3)
year_slope_variance[9]<-round(bgv3[which(bgv3$var1=="yearcenter"),"vcov"],3)
...
year_slope_variance[12]<-round(afv3[which(afv3$var1=="yearcenter"),"vcov"],3)
...
year_slope_variance[15]<-round(afv3all[which(afv3all$var1=="yearcenter"),"vcov"],3)
...
year_slope_variance[18]<-round(agv3[which(agv3$var1=="yearcenter"),"vcov"],3)
...
year_slope_variance[21]<-round(sfv3[which(sfv3$var1=="yearcenter"),"vcov"],3)
...
year_slope_variance[24]<-round(sfv3all[which(sfv3all$var1=="yearcenter"),"vcov"],3)
...
year_slope_variance[27]<-round(sgv3[which(sgv3$var1=="yearcenter"),"vcov"],3)
...
lik.ratio[2]<-round(bfyeareffect$Chisq[2],4)
randomterm_pval[2]<-round(bfyeareffect$'Pr(>Chisq)'[2],4)

bfyeareffectall<-anova(biomass_forest_all2,biomass_forest_all1)
lik.ratio[5]<-round(bfyeareffectall$Chisq[2],4)
randomterm_pval[5]<-round(bfyeareffectall$'Pr(>Chisq)'[2],4)

bgyeareffect<-anova(biomass_grass2,biomass_grass1)
lik.ratio[8]<-round(bgyeareffect$Chisq[2],4)
randomterm_pval[8]<-round(bgyeareffect$'Pr(>Chisq)'[2],4)

afyeareffect<-anova(abundance_forest2,abundance_forest1)
lik.ratio[11]<-round(afyeareffect$Chisq[2],4)
randomterm_pval[11]<-round(afyeareffect$'Pr(>Chisq)'[2],4)

afyeareffectall<-anova(abundance_forest_all2,abundance_forest_all1)
lik.ratio[14]<-round(afyeareffectall$Chisq[2],4)
randomterm_pval[14]<-round(afyeareffectall$'Pr(>Chisq)'[2],4)

agyeareffect<-anova(abundance_grass2,abundance_grass1)
lik.ratio[17]<-round(agyeareffect$Chisq[2],4)
randomterm_pval[17]<-round(agyeareffect$'Pr(>Chisq)'[2],4)

sfyeareffect<-anova(species_forest2,species_forest1)
lik.ratio[20]<-round(sfyeareffect$Chisq[2],4)
randomterm_pval[20]<-round(sfyeareffect$'Pr(>Chisq)'[2],4)

sfyeareffectall<-anova(species_forest_all2,species_forest_all1)
lik.ratio[23]<-round(sfyeareffectall$Chisq[2],4)
randomterm_pval[23]<-round(sfyeareffectall$'Pr(>Chisq)'[2],4)

sgyeareffect<-anova(species_grass2,species_grass1)
lik.ratio[26]<-round(sgyeareffect$Chisq[2],4)
randomterm_pval[26]<-round(sgyeareffect$'Pr(>Chisq)'[2],4)

#extract likelihood ratio and LR test p value for comparisons of model types 2 and 3.
bfyearslopevariance<-anova(biomass_forest2,biomass_forest3)
lik.ratio[3]<-round(bfyearslopevariance$Chisq[2],4)
randomterm_pval[3]<-round(bfyearslopevariance$'Pr(>Chisq)'[2],4)

bfyearslopevarianceall<-anova(biomass_forest_all2,biomass_forest_all3)
lik.ratio[6]<-round(bfyearslopevarianceall$Chisq[2],4)
randomterm_pval[6]<-round(bfyearslopevarianceall$'Pr(>Chisq)'[2],4)

bgyearslopevariance<-anova(biomass_grass2,biomass_grass3)
lik.ratio[9]<-round(bgyearslopevariance$Chisq[2],4)
randomterm_pval[9]<-round(bgyearslopevariance$'Pr(>Chisq)'[2],4)

afyearslopevariance<-anova(abundance_forest2,abundance_forest3)
lik.ratio[12]<-round(afyearslopevariance$Chisq[2],4)
randomterm_pval[12]<-round(afyearslopevariance$'Pr(>Chisq)'[2],4)

afyearslopevarianceall<-anova(abundance_forest_all2,abundance_forest_all3)
lik.ratio[15]<-round(afyearslopevarianceall$Chisq[2],4)
randomterm_pval[15]<-round(afyearslopevarianceall$'Pr(>Chisq)'[2],4)

agyearslopevariance<-anova(abundance_grass2,abundance_grass3)
lik.ratio[18]<-round(agyearslopevariance$Chisq[2],4)
randomterm_pval[18]<-round(agyearslopevariance$'Pr(>Chisq)'[2],4)

sfyearslopevariance<-anova(species_forest2,species_forest3)
lik.ratio[21]<-round(sfyearslopevariance$Chisq[2],4)
randomterm_pval[21]<-round(sfyearslopevariance$'Pr(>Chisq)'[2],4)

sfyearslopevarianceall<-anova(species_forest_all2,species_forest_all3)
lik.ratio[24]<-round(sfyearslopevarianceall$Chisq[2],4)
randomterm_pval[24]<-round(sfyearslopevarianceall$'Pr(>Chisq)'[2],4)

sgyearslopevariance<-anova(species_grass2,species_grass3)
lik.ratio[27]<-round(sgyearslopevariance$Chisq[2],4)
randomterm_pval[27]<-round(sgyearslopevariance$'Pr(>Chisq)'[2],4)
...
tableoutput<-cbind(habitat,response,plots,modeltype,coefsandse,propchange,pvalues,year_variance,year_slope_variance,lik.ratio,randomterm_pval)
write.table(tableoutput,"modeltable.txt",sep="\t",col.names=T,row.names=F)
